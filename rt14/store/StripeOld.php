...
start_box();
echo "<h2>".pcrtlang("Swipe Credit Card NOW")."! (Stripe)</h2>";

echo "<form name=c action=$securedomain/StripeOld.php?func=add2 method=post><input autofocus class=textbox type=password name=swipedata autocomplete=off>";
...
echo "<table><tr><td><form action=$securedomain/StripeOld.php?func=add3 method=post>";
