...
start_blue_box(pcrtlang("Add Cash Payment"));
if ($isdeposit != 1) {
echo "<span class=\"sizemelarge\">".pcrtlang("Balance").": $money".mf("$currenttotal")."</span><br><br>";
}
echo "<table><tr><td><form action=Cash.php?func=add2 method=post>";




echo "<tr><td>".pcrtlang("Amount to Pay").": <br><span class=\"sizemesmaller italme\">".pcrtlang("amount to pay with this method")."</span></td><td>$money<input autofocus type=text class=textboxw name=amounttopay value=\"".mf("$currenttotal")."\"></td></tr>";
echo "<tr><td>".pcrtlang("Amount Tendered").": </td><td>$money<input type=text class=textboxw name=amounttendered>";

echo "</td></tr>";
echo "<tr><td colspan=2>&nbsp;</td></tr>";

echo "<tr><td>".pcrtlang("Customer Name").": </td><td><input type=text class=textboxw name=cfirstname value=\"$cfirstname\"></td></tr>";
echo "<tr><td>".pcrtlang("Company").": </td><td><input type=text class=textboxw name=ccompany value=\"$ccompany\"></td></tr>";
...
echo "<tr><td></td><td><input type=submit class=button value=\"".pcrtlang("Next")." -&gt;\"></form></td></tr></table>";
stop_blue_box();
...
echo "<form action=Cash.php?func=add3 method=post><span class=\"sizemelarge\">".pcrtlang("Change").": $changeformatted</span><br><br>";
...
echo "<input type=hidden value=\"$amounttopay\" name=amounttopay><input type=submit class=ibutton value=\"".pcrtlang("Add Payment")."\" onclick=\"this.disabled=true;this.value='".pcrtlang("Adding Payment")."...'; this.form.submit();\"></form>";
stop_blue_box();
...
header("Location: deposits.php?func=deposit_receipt&depositid=$depositid&woid=$woid&invoiceid=$invoiceid");
} else {
