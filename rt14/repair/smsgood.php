...
echo "<h2>".pcrtlang("Send SMS Message")." (".pcrtlang("gateway").": $mysmsgateway)</h2><br><br>";
}
...
echo "<tr><td>".pcrtlang("SMS Number").":<input type=hidden name=woid value=$woid></td>";
...
echo "<tr><td>".pcrtlang("Quick Message").":</td>";
...
echo "<tr><td>".pcrtlang("Message").":<br><input type=hidden name=woid value=$woid></td>";

echo "<td><textarea cols=60 rows=4 name=smsmessage id=smsmessage class=textbox name=smsbox></textarea>";

echo "<br><span class=colormegreen>".pcrtlang("Characters Remaining").": <span id=\"charsLeft\"></span></span></td></tr>";
...
$smsnumber = "$mysmsprefix"."$smsnumber";
...
$rs_insert_message = "INSERT INTO messages (messagefrom,messagebody,messagedatetime,messagevia,messageservice,woid,groupid,messagedirection)
VALUES ('$ipofpc','$smsmessagesafe','$currentdatetime','sms','redoxygen','$woid','$groupid','out')";
...
#$rs_change_pc = "UPDATE pc_wo SET called = '5' WHERE woid = '$woid'";
#@mysqli_query($rs_connect, $rs_change_pc);


$rs_insert_message = "INSERT INTO messages (messagefrom,messagebody,messagedatetime,messagevia,messageservice,woid,groupid,messagedirection)
VALUES ('$ipofpc','$smsmessagesafe','$currentdatetime','sms','bulksms','$woid','$groupid','out')";
@mysqli_query($rs_connect, $rs_insert_message);
...
#@mysqli_query($rs_connect, $rs_change_pc);
$rs_insert_message = "INSERT INTO messages (messagefrom,messagebody,messagedatetime,messagevia,messageservice,woid,groupid,messagedirection)
VALUES ('$ipofpc','$smsmessagesafe','$currentdatetime','sms','clickatell','$woid','$groupid','out')";
@mysqli_query($rs_connect, $rs_insert_message);
            ...
            curl_setopt($ch, CURLOPT_HTTPHEADER,     array(
                "X-Version: 1",
			        ...
			        $smssuccess = 1;
                            	userlog(14,$woid,'woid',"$smsnumber - $smsmessagesafe");
				$rs_insert_message = "INSERT INTO messages (messagefrom,messagebody,messagedatetime,messagevia,messageservice,woid,groupid,messagedirection)
				VALUES ('$ipofpc','$smsmessagesafe','$currentdatetime','sms','clickatellrest','$woid','$groupid','out')";
				@mysqli_query($rs_connect, $rs_insert_message);
                            	#$rs_change_pc = "UPDATE pc_wo SET called = '5' WHERE woid = '$woid'";
                            	#@mysqli_query($rs_connect, $rs_change_pc);
                            } else {
...
$rs_insert_message = "INSERT INTO messages (messagefrom,messagebody,messagedatetime,messagevia,messageservice,woid,groupid,messagedirection)
VALUES ('$ipofpc','$smsmessagesafe','$currentdatetime','sms','twilio','$woid','$groupid','out')";
@mysqli_query($rs_connect, $rs_insert_message);
...
$rs_insert_message = "INSERT INTO messages (messagefrom,messagebody,messagedatetime,messagevia,messageservice,woid,groupid,messagedirection)
VALUES ('$ipofpc','$smsmessagesafe','$currentdatetime','sms','mymobileapi.com','$woid','$groupid','out')";
@mysqli_query($rs_connect, $rs_insert_message);
...
$rs_insert_message = "INSERT INTO messages (messagefrom,messagebody,messagedatetime,messagevia,messageservice,woid,groupid,messagedirection)
VALUES ('$ipofpc','$smsmessagesafe','$currentdatetime','sms','reliancesms.com','$woid','$groupid','out')";
@mysqli_query($rs_connect, $rs_insert_message);
