...
<span class="floatright colormegray">This system &copy;<?php echo date("Y"); ?> PC Repair Tracker v9
<?php
...
<script>
function loadworkorder(pcwo){
   $("#mainworkorder").load('wo.php?pcwo='+pcwo+'&time=<?php echo time(); ?>');
}
