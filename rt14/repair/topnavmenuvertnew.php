...
<?php
if (perm_check("25")) {
echo "<a href=\"../store/reports.php?func=browse_receipts\" class=menulink><img src=../store/images/receipts.png class=menuicon> ".pcrtlang("Receipts")."</a>";
}
?>
...
if (perm_check("6")) {
echo "<a href=\"../store/categories.php\" class=menulink><img src=../store/images/inventory.png class=menuicon> ".pcrtlang("Inventory")."</a>";
}
if (perm_check("23")) {
echo "<a href=\"../store/suppliers.php\" class=menulink><img src=../store/images/suppliers.png class=menuicon> ".pcrtlang("Suppliers")."</a>";
}

echo "<a href=\"../store/stock.php?func=specialorders\" class=menulink><img src=../store/images/specialorder.png class=menuicon> ".pcrtlang("Special Orders")."</a>";
