...
$number = pv($_REQUEST['sender']);
$body = pv($_REQUEST['message']);
$to = pv($_REQUEST['msisdn']);
...
$rs_insert_message = "INSERT INTO messages (messagefrom,messageto,messagebody,messageraw,messagedatetime,messagevia,messageservice,messagedirection) VALUES ('$number','$to','$body','$messageraw','$currentdatetime','sms','bulksms','in')";
