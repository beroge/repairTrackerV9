...
dheader(pcrtlang("Add Check Payment"));
if($isdeposit != 1) {
echo pcrtlang("Balance").": $money".mf("$currenttotal")."<br><br>";
}
echo "<form action=Check.php?func=add2 method=post data-ajax=\"false\">";
echo pcrtlang("Check Amount").": <input type=text name=checkamount value=\"".mf("$currenttotal")."\">";
echo pcrtlang("Check Number").": <input type=text name=checknumber>";
echo pcrtlang("Drivers License Number").": <input type=text name=driverslc onFocus=\"this.form.submitbutton.disabled=false;this.form.submitbutton.value='".pcrtlang("Add Check Payment")."';\">";
echo pcrtlang("Phone").": <input type=text name=cphone value=\"$cphone\">";

echo "<br>";

echo pcrtlang("Name on Check").": ";
echo "<input type=text name=cfirstname value=\"$cfirstname\">";
...
echo "$pcrt_address2: ";
echo "<input typ=text name=caddress2 value=\"$caddress2\">";
...
echo pcrtlang("Email").": ";
echo "<input type=text name=cemail value=\"$cemail\">";

echo "<input type=submit id=submitbutton value=\"".pcrtlang("Add Check Payment")."\" onclick=\"this.disabled=true;this.value='".pcrtlang("Adding Check Payment")."...'; this.form.submit();\"></form>";
dfooter();
