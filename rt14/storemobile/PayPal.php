...
dheader("PayPal");
echo pcrtlang("Swipe Credit Card NOW!")." (PayPal)<br><br>";

echo "<form name=c action=$securedomain"."mobile/PayPal.php?func=add2 method=post data-ajax=\"false\"><input autofocus class=textbox type=password name=swipedata>";
...
echo "<form action=$securedomain"."mobile/PayPal.php?func=add3 method=post>";
echo pcrtlang("Amount to Pay").": ";

if("$taxamt" != "") { 
echo "<input type=text name=cardamount readonly value=\"".mf("$currenttotal")."\">";
} else {
echo "<input type=text name=cardamount value=\"".mf("$currenttotal")."\" size=15>";
}
...
echo pcrtlang("Expiration Year").": <input type=text name=ccyear value=\"20$ccexpyear\"> <font class=em90>".pcrtlang("4 digits")."</font><br><br>";
echo "CID: <input type=text name=cccid>";

echo pcrtlang("Card Type").": <select name=cardtype  data-native-menu=\"false\">";
