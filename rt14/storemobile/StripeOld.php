...
echo "<form name=c action=$securedomain"."mobile/Stripe.php?func=add2 method=post data-ajax=\"false\"><input autofocus type=password name=swipedata autocomplete=off>";
...
echo "<div data-role=\"header\" data-theme=\"b\"><h2>".pcrtlang("Charge Card")."</h2></div>";
echo "<div class=\"ui-content\" role=\"main\">";

if($isdeposit != 1) {
echo pcrtlang("Balance").": $money".mf("$currenttotal")."<br><br>";
}
echo "<form action=$securedomain"."mobile/Stripe.php?func=add3 method=post data-ajax=\"false\">";
echo pcrtlang("Amount to Pay").": <input type=text name=cardamount value=\"".mf("$currenttotal")."\">";
echo pcrtlang("Credit Card Number").": <input type=text name=ccnumber value=\"$cardnumber\"> ".pcrtlang("16 digits, no dashes or spaces")."<br><br>";
echo pcrtlang("Expiration Month").": <input type=text name=ccmonth value=\"$ccexpmonth\"> ".pcrtlang("2 digits")."<br><br>";
echo pcrtlang("Expiration Year").": <input type=text name=ccyear value=\"$ccexpyear\">".pcrtlang("4 digits")."<br><br>";
echo pcrtlang("CID").": </font><input type=text name=cccid><br>";
...
echo "$pcrt_state";
echo "<input type=text name=cstate value=\"$cstate\">";

echo "$pcrt_zip ";
echo "<input type=text name=czip value=\"$czip\">";
...
echo "<input type=submit value=\"".pcrtlang("Add Credit Card Payment")."\" onclick=\"this.disabled=false;this.value='".pcrtlang("Adding Credit Card Payment")."...'; this.form.submit();\"></form>";
