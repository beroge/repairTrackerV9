...
echo pcrtlang("Error: Receipt Not Found");
}
...
echo "<center><h3>".pcrtlang("Receipt")."# $receipt<br></h3></center>";
...
if ($rs_email != "") {
echo "<button type=button onClick=\"parent.location='mailto:$rs_email'\"> <i class=\"fa fa-envelope fa-lg\"></i> $rs_email</button>";
}


echo "<button type=button onClick=\"parent.location='receipt.php?func=show_receipt_printable&receipt=$receipt'\"><i class=\"fa fa-print fa-lg\"></i> ".pcrtlang("Printable Receipt")."</button>";
echo "<button type=button onClick=\"parent.location='receipt.php?func=email_receipt&receipt=$receipt'\"><i class=\"fa fa-envelope fa-lg\"></i> ".pcrtlang("Email Receipt")."</button><br><br>";
...
echo "<br>".pcrtlang("Store").": $storeinfoarray[storesname]";
}
...
echo "<button type=button onClick=\"parent.location='invoice.php?func=printinv&invoice_id=$rs_invoice_id'\" data-mini=\"true\">#$rs_invoice_id</button>";
}
...
echo "<button type=button onClick=\"parent.location='../repairmobile/pc.php?func=view&woid=$rs_woidids'\" data-mini=\"true\">#$rs_woidids</button> ";
}
}
...
echo "<br><center><h3><i class=\"fa fa-cog fa-spin\"></i>";
echo "$totalreturnitems ".pcrtlang("Item(s) are in the Current Cart Ready for Return")."</h3></center>";
echo "<button TYPE=button onClick=\"parent.location='cart.php'\" data-theme=\"b\"><i class=\"fa fa-cog fa-spin\"></i> ".pcrtlang("Go to Current Cart")."</button>";
}

echo "<br><table class=cart><tr><th colspan=2>";
echo pcrtlang("Purchase Items")."</th></td>";
...
$rs_unit_tax = $rs_itemtax / $rs_quantity;
...
if ($rs_itemserial != "") {
echo "<br><font class=class=em90>".pcrtlang("Serial/Code").": $rs_itemserial</font>";
}
...
echo "<br>(".qf("$returned_quantity").") ".pcrtlang("Returned on Receipt")."  <button type=button onClick=\"parent.location='receipt.php?func=show_receipt&receipt=$returned_receipt'\" class=\"ui-btn ui-corner-all ui-shadow ui-btn-inline ui-mini\"  data-ajax=\"false\">#$returned_receipt</button>";
}
...
echo "<br><font class=em90>".pcrtlang("Flagged for Return")."</font>";
}
echo "</td><td style=\"text-align:right;\"><strong>".qf("$rs_quantity")."X$money".limf("$rs_unit_price","$rs_unit_tax")."<br>$money".limf("$rs_cart_price","$rs_itemtax")."</strong></td></tr>";


if (($rs_return_flag !=  'flagged') && ($quantityleft == '1') && ($allowreturn == 1)) {
echo "<tr><td colspan=2>";

echo "<div data-role=\"collapsible\" data-theme=\"b\" data-mini=\"true\">";
echo "<h3>".pcrtlang("Return Actions")."</h3>";

echo pcrtlang("Return Item");
echo "<form action=cart.php?func=add_return method=post data-ajax=\"false\"><input type=hidden name=receipt value=$receipt>";
...
echo "</select>";
echo "<input type=hidden name=stocktitle value=\"$rs_stocktitle\"><input type=submit class=button style=\"padding:1px;\" value=\"".pcrtlang("Return Item")."\"></form>";
...
echo "<tr><th colspan=2>".pcrtlang("Labor")."</td></tr>";
...
echo "<strong>$rs_cart_labor_desc</strong>";
...
echo "<br>(".qf("$laborreturned_quantity").") ".pcrtlang("Returned on Receipt")."
<button type=button onClick=\"parent.location='receipt.php?func=show_receipt&receipt=$laborreturned_receipt'\" class=\"ui-btn ui-corner-all ui-shadow ui-btn-inline ui-mini\"  data-ajax=\"false\">#$laborreturned_receipt</button>";
}
...
echo "</td><td style=\"text-align:right;\">".qf("$rs_cart_labor_quantity")."X$money".limf("$rs_cart_labor_unit_price","$rs_labor_unit_tax")."<br><strong>$money".limf("$rs_cart_labor_price","$rs_labor_itemtax")."</strong></td></tr>";

if (($rs_cart_labor_return_flag !=  'flagged') && ($laborquantityleft == '1') && ($allowreturn == 1) && perm_check("22")) {

echo "<tr><td colspan=2>";

echo "<form action=cart.php?func=refundlabor method=post data-ajax=\"false\"><input type=hidden name=receipt value=$receipt>";
echo "<input type=hidden name=cfirstname value=\"$rs_soldto\">";
echo "<input type=hidden name=ccompany value=\"$rs_company\">";
echo "<input type=hidden name=caddress value=\"$rs_ad1\">";
echo "<input type=hidden name=caddress2 value=\"$rs_ad2\">";
...
echo pcrtlang("Qty").":<input type=number name=quantity value=\"$laborquantityleftcount\" min=\".01\" max=\"$laborquantityleftcount\" step=\".01\">";
echo "<input type=submit class=button style=\"padding:1px;\" value=\"".pcrtlang("Refund Labor")."\"></form>";
...
echo "<tr><th colspan=2>".pcrtlang("Returned Items")."</td></tr>";
...
echo "<tr><td><strong>$rs_return_stocktitle</strong><br><font class=em90>Sold on Receipt:</font> <button type=button onClick=\"parent.location='receipt.php?func=show_receipt&receipt=$rs_return_original'\" class=\"ui-btn ui-corner-all ui-shadow ui-btn-inline ui-mini\"  data-ajax=\"false\">#$rs_return_original</button>";
echo "</td><td style=\"text-align:right;\">".qf("$rs_return_quantity")."X$money".limf("$rs_return_unit_price","$rs_return_unit_tax")."<br>$money".limf("$rs_cart_return_price","$rs_return_itemtax")."</td></tr>";
        }
...
echo "<tr><td colspan=2>".pcrtlang("No Refunded Labor Items")."</td></tr>";
}
...
$refundlabor_unit_tax = $refundlabor_itemtax / $rs_refundlabor_quantity;
...
echo "<tr><td>";
echo "<strong>$rs_cart_refundlabor_desc</strong><br><font class=em90>Billed on Receipt</font> <button type=button onClick=\"parent.location='receipt.php?func=show_receipt&receipt=$rs_return_original_rl'\" class=\"ui-btn ui-corner-all ui-shadow ui-btn-inline ui-mini\"  data-ajax=\"false\">#$rs_return_original_rl</button>";
echo "</td><td style=\"text-align:right;\">".qf("$rs_refundlabor_quantity")."X$money".limf("$rs_refundlabor_unit_price","$refundlabor_unit_tax")."<br><strong>$money".limf("$rs_cart_refundlabor_price","$rs_refundlabor_itemtax")."</strong></td></tr>";
...
echo "<tr><td style=\"text-align:right;\">".pcrtlang("Parts Subtotal").":</td><td style=\"text-align:right;\">$money".limf("$rs_total_parts","$rs_total_parts_tax")."</td></tr>";
...
if ($salestax > 0) {
echo "<tr><td style=\"text-align:right;\">$t_tax:</td><td style=\"text-align:right;\">$money".mf("$salestax")."</td></tr>";
}
}
}
...
echo "<tr><td style=\"text-align:right;\">".pcrtlang("Labor Total").":</td><td style=\"text-align:right;\">$money".limf("$rs_total_labor","$rs_total_labor_tax")."</td></tr>";
...
if ($servicetax > 0) {
echo "<tr><td style=\"text-align:right;\">$t_tax:</td><td style=\"text-align:right;\">$money".mf("$servicetax")."</td></tr>";
}
...
echo "<tr><td style=\"text-align:right;\">".pcrtlang("Refund Subtotal").":</td><td style=\"text-align:right;\">$money".limf("$rs_total_refund","$rs_total_refund_tax")."</td></tr>";
...
if ($refundtax > 0) {
echo "<tr><td style=\"text-align:right;\">".pcrtlang("Refunded")." $t_tax:</td><td style=\"text-align:right;\">$money".mf("$refundtax")."</td></tr>";
}
...
echo "<tr><td style=\"text-align:right;\">".pcrtlang("Refunded Labor Total").":</td><td style=\"text-align:right;\">$money".limf("$rs_total_refundlabor","$rs_total_refundlabor_tax")."</td></tr>";
...
echo "<tr><td style=\"text-align:right;\">$t_tax:</td><td style=\"text-align:right;\">$money".mf("$refundservicetax")."</td></tr>";
}
...
if ($grand_total >= 0){
echo "<tr><td style=\"text-align:right;\">".pcrtlang("Grand Total").":</td><td style=\"text-align:right;\">$money".mf("$grand_total")."</td></tr>";
} else {
$refund_total = abs($grand_total);
echo "<tr><td style=\"text-align:right;\">".pcrtlang("Refund").":</td><td style=\"text-align:right;\">$money".mf("$refund_total")."</td></tr>";
}
...
echo "<center><h3>".pcrtlang("Payments").":</h3></center>";
}
...
if ($paymenttype == "cash") {
echo "<strong>".pcrtlang("Cash")."</strong><br><font class=\"em90\">$pfirstname - $pcompany2$money".mf("$paymentamount")."</font>";
if($cashchange != "") {
$cashchange2 = explode('|', $cashchange);
echo "<br><font class=em90>".pcrtlang("Change").": $money".mf("$cashchange2[0]")." ".pcrtlang("Tendered").": $money".mf("$cashchange2[1]")."</font>";
if($depositid != "0") {
...
echo "<strong>".pcrtlang("Check")." #$checknumber&nbsp;</strong><br><font class=\"em90\">$pfirstname -$pcompany2";
echo "$money".mf("$paymentamount")."<br>$chk_dl<br>$paddress<br>$paddress2<br>$pcity $pstate $pzip<br>$pphone</font>";
if($depositid != "0") {
echo "<br>".pcrtlang("Deposit").": $depositid";
}
echo "<br><br>";
...
echo "<strong>".pcrtlang("Credit Card")."</strong><br><font class=\"em90\">XXXX-$ccnumber<br>";
echo pcrtlang("TransID").": $cc_transid<br>$pfirstname - $pcompany2$money".mf("$paymentamount")."<br>$paymentplugin $cc_cardtype</font>";
if($depositid != "0") {
echo "<br>".pcrtlang("Deposit").": $depositid";
}
echo "<br><br>";
...
echo "<strong>$paymentplugin&nbsp;</strong><br><font class=\"em90\">$pfirstname - $pcompany2$money".mf("$paymentamount")."</font><br>";

reset($custompaymentinfo);
foreach($custompaymentinfo as $key => $val) {
if(!in_array("$key", $CustomPaymentPrintExclude)) {
echo "<font class=\"em90\">$key: $val</font><br>";
}
}
...
echo "<button type=button onClick=\"parent.location='receipt.php?func=email_receipt&receipt=$receipt'\"><i class=\"fa fa-envelope fa-lg\"></i> ".pcrtlang("Email Receipt")."</button>";

echo "<br>";

if (perm_check("4")) {

echo "<a href=\"#popupdeleterec\" data-rel=\"popup\" data-position-to=\"window\" data-transition=\"pop\" class=\"ui-btn ui-shadow ui-corner-all\">";
echo "<i class=\"fa fa-trash fa-lg\"></i> ".pcrtlang("Delete Receipt")."</a>";
echo "<div data-role=\"popup\" id=\"popupdeleterec\" data-overlay-theme=\"b\"  data-theme=\"a\" data-dismissible=\"false\">";
echo "<div data-role=\"header\" data-theme=\"b\">";
echo "<h1>".pcrtlang("Delete Receipt")."?</h1>";
echo "</div>";
echo "<div role=\"main\" class=\"ui-content\">";
echo "<p>".pcrtlang("Are you sure you wish to permanently void and delete this receipt!!!?")."</p>";
...
echo "<button onClick=\"parent.location='receipt.php?func=delete_receipt&receipt=$receipt'\" data-inline=\"true\">";
...
echo "<br><form method=post action=receipt.php?func=move_receipt data-ajax=\"false\">".pcrtlang("Move Receipt to a Different Store:")."";
echo "<input type=hidden name=receipt value=\"$receipt\"><input type=hidden name=oldstore value=\"$rs_storeid\"><select name=newstore class=select onchange='this.form.submit()'  data-native-menu=\"false\">";
...
echo "<h3>".pcrtlang("Receipt History")."</h3>";
...
echo "<strong>($loggeduser) $loggedactions[$rs_actionid]</strong>";
echo "<br><font class=em90>$rs_thedatetime<br>$mensaje</font><br><br>";
...
echo "<button onClick=\"parent.location='$returnurl'\" class=bigbutton><img src=../store/images/left.png style=\"vertical-align:middle;margin-bottom: .25em;\"></button>";
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
...
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
echo "<button onClick=\"parent.location='receipt.php?func=email_receipt&receipt=$receipt'\" class=bigbutton><img src=../repair/images/email.png style=\"vertical-align:middle;margin-bottom: .25em;\"> ".pcrtlang("Email")."</button>";
echo "&nbsp;&nbsp;&nbsp;";
$returnreceipt = urlencode("../storemobile/reports.php?func=browse_receipts");
if($receiptsnarrow == 0) {
...
echo "<button onClick=\"parent.location='../repairmobile/admin.php?func=switch_receipt&receipt=$returnreceipt&switch=0'\" class=bigbutton><img src=../repair/images/widereceipts.png style=\"vertical-align:middle;margin-bottom: .25em;\"></button>";
}
...
if (count($receiptarray) == 1) {
echo "<div class=printbar>";
echo "<button onClick=\"parent.location='receipt.php?func=show_receipt&receipt=$receipt'\" class=bigbutton><img src=../store/images/left.png style=\"vertical-align:middle;margin-bottom: .25em;\"></button>";
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
echo "<button onClick=\"print();\" class=bigbutton><img src=../repair/images/print.png style=\"vertical-align:middle;margin-bottom: .25em;\"> ".pcrtlang("Print")."</button>";
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
...
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
$returnreceipt = urlencode("../storemobile/receipt.php?func=show_receipt_printable&receipt=$receipt");
if($receiptsnarrow == 0) {
echo "<button onClick=\"parent.location='../repairmobile/admin.php?func=switch_receipt&receipt=$returnreceipt&switch=1'\" class=bigbutton><img src=../store/images/narrowreceipts.png style=\"
vertical-align:middle;margin-bottom: .25em;\"></button>";
} else {
echo "<button onClick=\"parent.location='../repairmobile/admin.php?func=switch_receipt&receipt=$returnreceipt&switch=0'\" class=bigbutton><img src=../store/images/widereceipts.png style=\"
vertical-align:middle;margin-bottom: .25em;\"></button>";
}
...
if ($rs_email != "") {
echo "<br><br>".pcrtlang("Email").": $rs_email";
}
...
echo "<img src=../repair/$printablelogo width=200><br><span class=\"sizemesmaller italme\">$servicebyline</span><br><br>";
echo "$storeinfoarray[storename]<br>$storeinfoarray[storeaddy1]";
if ("$storeinfoarray[storeaddy2]" != "") {
echo "<br>$storeinfoarray[storeaddy2]";
}
...
if ($rs_return_receipt != "") {
if(!$narrow) {
echo "<br><span class=\"colormegreen italme\">".pcrtlang("Returned on Receipt")." </span><a href=receipt.php?func=show_receipt&receipt=$rs_return_receipt>#$rs_return_receipt</a>";
} else {
echo "<br><span class=\"sizemesmaller italme\">".pcrtlang("Returned on Receipt").": #$rs_return_receipt</span>";
}
}
...
if(!$narrow) {
echo "</td><td width=15%>$money".limf("$lunit_price","$lunit_tax")."</td><td width=15%>$money".limf("$rs_cart_labor_price","$itemtax")."";
} else {
echo "</td><td width=15%>$money".limf("$lunit_price","$lunit_tax")."</td><td width=30%  colspan=2><span class=\"sizemesmaller boldme\">$money".limf("$rs_cart_labor_price","$itemtax")."</span>";
}
...
echo " #$rs_return_original</span></td>";
echo "<td width=15%>$money".limf("$runitprice","$runit_tax")."</td><td width=30% colspan=2>$money".limf("$rs_cart_return_price","$ritemtax");
}
...
if(!$narrow) {
echo "</td><td width=15%>$money".limf("$refundlaborunit_price","$refundlunit_tax")."</td><td width=15%>$money".limf("$rs_cart_refundlabor_price","$refundlitemtax")."";
} else {
echo "</td><td width=15%>$money".limf("$refundlaborunit_price","$refundlunit_tax")."</td><td width=30%  colspan=2><span class=\"sizemesmaller boldme\">$money".limf("$rs_cart_refundlabor_price","$refundlitemtax")."</span>";
}
...
echo "<td width=15%><span class=\"sizemesmaller boldme\">$money".limf("$rs_total_refund","$rs_total_refund_tax")."</span>";
echo "</td></tr>";
...
$rs_find_name = "SELECT * FROM receipts WHERE person_name LIKE '%$thesearch%' OR company LIKE '%$thesearch%' OR email LIKE '%$thesearch%' OR phone_number LIKE '%$thesearch%' ORDER BY date_sold DESC";
$rs_result_name = mysqli_query($rs_connect, $rs_find_name);
...
echo "<tr bgcolor=#cccccc><td align=right><font class=text12b>".pcrtlang("Receipt No.")."</font></td><td><font class=text12b>".pcrtlang("Customer Name")."</font></td><td><font class=text12b>".pcrtlang("Date Sold")."</font></td><td><font class=text12b>".pcrtlang("Grand Total")."</font></td></tr>";

if (mysqli_num_rows($rs_result_name) == 0) {
echo "<tr><td colspan=4><font class=text12>".pcrtlang("No Results Found")."</font></td></tr>";
}
...
echo "<tr><td align=right><font class=text12b>$rs_rt</font></td><td><a href=receipt.php?func=show_receipt&receipt=$rs_rt>$rs_soldto$rs_company2</a></td><td><font class=text12>$rs_date2</font></td><td><font class=text12b>$money".mf("$rtot")."</font></td></tr>";
...
dheader(pcrtlang("Email Receipt")." #$receipt");

echo pcrtlang("Enter Email Address").":<form action=receipt.php?func=email_receipt2 method=POST data-ajax=\"false\">";
echo "<input type=text value=\"$rs_email\" name=email><input type=hidden value=$receipt name=receipt>";
echo "<input type=submit value=\"".pcrtlang("Email Receipt")."\"  data-theme=\"b\"></form><br><br>";
...
$pearhtml .= "<img src=../store/$logo><br><font face=arial size=3><i>$servicebyline</i>";
...
if (($price_alt == 1) && ($origprice > $unit_price)) {
$origunitpricetax = $origprice * getsalestaxrate($taxex);
$message .= "<br><font size=1><i>".pcrtlang("was")." $money".limf("$origprice","$itemtax")."</i></font>";
$pearhtml .= "<br><font size=1><i>".pcrtlang("was")." $money".limf("$origprice","$itemtax")."</i></font>";
}
...
$refundlunit_tax = $refundlitemtax / $refundlquantity;
...
$message .= "</td><td width=15% align=right>".limf("$refundlunit_price","$refundlunit_tax")."</td><td width=15% align=right>$money".limf("$rs_cart_refundlabor_price","$refundlitemtax")."";
$message .= "</td><td width=15% align=right>";
...
$pearhtml .= "</td><td width=15% align=right>".limf("$refundlunit_price","$refundlunit_tax")."</td><td width=15% align=right>$money".limf("$rs_cart_refundlabor_price","$refundlitemtax")."";
$pearhtml .= "</td><td width=15% align=right>";


reset($refundlaboritemtax);
foreach($refundlaboritems as $key => $val) {
$shortname = gettaxshortname($key);
if($val != 0) {
...
$rs_find_item_total = "SELECT SUM(sold_price) AS total_price_parts, SUM(sold_price) AS total_price_parts_tax FROM sold_items WHERE sold_type = 'purchase' AND receipt = '$receipt'";
$rs_find_result_total = mysqli_query($rs_connect, $rs_find_item_total);
while($rs_find_result_total_q = mysqli_fetch_object($rs_find_result_total)) {
$rs_total_parts = "$rs_find_result_total_q->total_price_parts";
$rs_total_parts_tax = "$rs_find_result_total_q->total_price_parts_tax";
...
$rs_find_labor_total = "SELECT SUM(sold_price) AS total_labor_price, SUM(sold_price) AS total_labor_price_tax FROM sold_items WHERE sold_type = 'labor' AND receipt = '$receipt'";
$rs_find_result_labor_total = mysqli_query($rs_connect, $rs_find_labor_total);
...
$rs_find_refund_total = "SELECT SUM(sold_price) AS total_price_parts, SUM(sold_price) AS total_price_parts_tax FROM sold_items WHERE sold_type = 'refund' AND receipt = '$receipt'";
$rs_find_result_refund_total = mysqli_query($rs_connect, $rs_find_refund_total);
while($rs_find_result_refund_total_q = mysqli_fetch_object($rs_find_result_refund_total)) {
$rs_total_refund = "$rs_find_result_refund_total_q->total_price_parts";
$rs_total_refund_tax = "$rs_find_result_refund_total_q->total_price_parts_tax";
...
$pearhtml .= "<td width=15% align=right>$money".mf("$rs_total_refundlabor","$rs_total_refundlabor_tax")."</td></tr>";
...
echo "<form action=receipt.php?func=search_receipt method=POST data-ajax=\"false\">";
...
echo "<form action=invoice.php?func=searchinvoices method=POST data-ajax=\"false\">";
...
echo "<form action=deposits.php?func=searchdeposits method=POST data-ajax=\"false\">";
echo "<input type=text value=\"$searchterm\" name=searchterm class=textbox size=25>";
