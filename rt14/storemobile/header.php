...
echo "<button  onClick=\"parent.location='../repairmobile/pc.php?func=showworkorders'\"><i class=\"fa fa-wrench fa-lg\"></i> ".pcrtlang("Work Orders")."</button>";
...
echo "<button type=button onClick=\"parent.location='../repairmobile/autosearch.php?func=search'\"><i class=\"fa fa-search fa-lg\"></i>".pcrtlang("Search")."</button>";

echo "<button  onClick=\"parent.location='../repairmobile/'\"><i class=\"fa fa-file-o fa-lg\"></i> ".pcrtlang("Sticky Wall")."</button>";
...
#echo "<button  onClick=\"parent.location='../repairmobile/pc.php?func=frameit'\"><i class=\"fa fa-wrench fa-lg\"></i> ".pcrtlang("Tools &amp Docs")."</button>";
#echo "<button  onClick=\"parent.location='../repairmobile/admin.php'\"><i class=\"fa fa-cog fa-lg\"></i> ".pcrtlang("Settings")."</button>";
...
<?php
#echo "<button type=button onClick=\"parent.location='../repair/admin.php'\"><i class=\"fa fa-cog fa-lg\"></i> ".pcrtlang("Settings")."</button>";
echo "<button type=button onClick=\"parent.location='../repair/logout.php'\"><i class=\"fa fa-sign-out fa-lg\"></i> ".pcrtlang("Logout")."</button>";
?>
