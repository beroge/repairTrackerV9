...
$rs_update_avg_cost = "UPDATE stock SET avg_cost = (avg_cost * $rs_stock_quantity + $return_ourprice) / ($rs_stock_quantity + 1) WHERE stock_id = '$returns_stockid'";
...
$rs_replace_stock = "UPDATE sold_items SET return_receipt = '$receiptnumber' WHERE sold_id = '$return_sold_id'";
@mysqli_query($rs_connect, $rs_replace_stock);
...
$refundlabor_sold_id = "$rs_find_refundlabor_q->return_sold_id";
...
$rs_replace_markref = "UPDATE sold_items SET return_receipt = '$receiptnumber' WHERE sold_id = '$refundlabor_sold_id'";
